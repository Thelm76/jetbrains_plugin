...
import dev.sweep.assistant.autocomplete.edit.EditorDiagnostic
import dev.sweep.assistant.autocomplete.edit.FileChunk
...
import dev.sweep.assistant.autocomplete.edit.UserAction
...
class OpenAiAutocompleteService(
    ...
    private fun buildHttpClient(settings: SweepSettings): HttpClient {
        val builder =
            HttpClient
                .newBuilder()
