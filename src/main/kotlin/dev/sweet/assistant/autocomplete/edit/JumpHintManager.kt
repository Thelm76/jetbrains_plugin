...
import dev.sweet.assistant.utils.contrastWithTheme
import java.awt.*
    ...
    override fun paint(
        ...
        val backgroundColor =
            editor.colorsScheme.defaultBackground
                .brighter()
                .withAlpha(0.8f)
        val borderColor = SweetColors.foregroundColor.withAlpha(0.3f)
        ...
        g2d.color = SweetColors.foregroundColor.withAlpha(0.1f) // More translucent foreground color
        ...
        g2d.color = if (isDarkMode) SweetColors.foregroundColor.withAlpha(0.8f) else SweetColors.foregroundColor
    ...
    fun createJumpHintComponent(): JComponent =
        object : JComponent() {
            override fun paintComponent(g: Graphics) {
                ...
                g2d.color = SweetColors.foregroundColor.withAlpha(0.1f)
                g2d.fillRoundRect(tabX, tabY, tabWidth + tabHorizontalPadding * 2, tabHeight, 4, 4)
