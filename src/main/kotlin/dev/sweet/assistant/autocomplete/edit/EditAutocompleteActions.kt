 ...
 * SweetActionPromoter ensures this action takes priority when autocomplete is shown.
 */
class AcceptEditCompletionAction : EditCompletionActionBase() {
    companion object {
        const val ACTION_ID = "dev.sweet.assistant.autocomplete.edit.AcceptEditCompletionAction"
    }
...
class RejectEditCompletionAction : EditCompletionActionBase() {
    companion object {
        const val ACTION_ID = "dev.sweet.assistant.autocomplete.edit.RejectEditCompletionAction"
    }
...
class TriggerEditCompletionAction : AnAction() {
    companion object {
        const val ACTION_ID = "dev.sweet.assistant.autocomplete.edit.TriggerEditCompletionAction"
    }
