...
import dev.sweet.assistant.utils.parseKeyStrokesToPrint
...
class EditorActionsRouterService : Disposable {
    ...
    // when a Sweet suggestion is visible.
    private val gatewayClientTabDispatcher: IdeEventQueue.EventDispatcher =
        IdeEventQueue.EventDispatcher dispatcher@{ e: AWTEvent ->
            if (SweetConstants.GATEWAY_MODE != SweetConstants.GatewayMode.CLIENT) return@dispatcher false
    ...
    companion object {
        ...
        private const val REJECT_ACTION_ID = "dev.sweet.assistant.autocomplete.edit.RejectEditCompletionAction"
    }
                    ...
                    override fun doExecute(
                        ...
                        if (true) {
                            ...
                            if (actionId == IdeActions.ACTION_EDITOR_NEXT_WORD &&
                                SweetSettings.getInstance().acceptWordOnRightArrow &&
