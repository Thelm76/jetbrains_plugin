...
import dev.sweet.assistant.services.SweetProjectService
...
import dev.sweet.assistant.utils.isAllAdditions
import dev.sweet.assistant.views.PopupEditorComponent
        ...
        override fun show(
            ...
            val attributes =
                TextAttributes().apply {
                    ...
                    backgroundColor =
                        if (forceHighlight || isPureWhitespace) SweetColors.whitespaceHighlightColor else SweetColors.transparent
                    effectType = null
                    fontType = Font.PLAIN
                }
            ...
            if (firstLineContent.isNotEmpty()) {
                ...
                // Register renderer as disposable child using SweetProjectService as parent
                val parentDisposable =
                    editor.project?.let {
                        SweetProjectService.getInstance(it)
