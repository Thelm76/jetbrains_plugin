package dev.sweet.assistant.views
...
class PopupEditorComponent(
    ...
    companion object {
        private val ADDITION_HIGHLIGHT_COLOR = SweetColors.additionHighlightColor
        private val DELETION_HIGHLIGHT_COLOR = SweetColors.deletionHighlightColor
                ...
                if (hunk.hasAdditions) {
                    ...
                    val attributes =
                        TextAttributes().apply {
                            backgroundColor = SweetColors.acceptedGlowColor
                            effectType = null
                            effectColor = SweetColors.acceptedHighlightColor
                        }
