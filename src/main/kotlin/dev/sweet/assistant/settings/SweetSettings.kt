...
@State(
    name = "dev.sweet.jetbrains.settings.SweetSettings",
    storages = [Storage("SweetSettings.xml")],
)
class SweetSettings : PersistentStateComponent<SweetSettings> {
    companion object {
        ...
        fun getInstance(): SweetSettings = ApplicationManager.getApplication().getService(SweetSettings::class.java)
    }
    ...
    override fun getState(): SweetSettings = this

    override fun loadState(state: SweetSettings) {
